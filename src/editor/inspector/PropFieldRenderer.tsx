...
export function PropFieldRenderer({ field, propsValue, nodePropsValue = propsValue, onChange }: Props) {
  ...
  return (
    <Form.Item label={field.label}>
      ...
      {editor === 'options' ? <CollectionItemsEditor value={Array.isArray(value) ? value : []} addLabel="Add option" onChange={(next) => updateField(propsValue, field, next as JsonValue, onChange)} /> : null}
      {editor === 'tabsItems' ? <CollectionItemsEditor value={Array.isArray(value) ? value : []} addLabel="Add tab" onChange={(next) => updateField(propsValue, field, next as JsonValue, onChange)} /> : null}
      {editor === 'stepsItems' ? <CollectionItemsEditor value={Array.isArray(value) ? value : []} addLabel="Add step" onChange={(next) => updateField(propsValue, field, next as JsonValue, onChange)} /> : null}
      {editor === 'treeData' ? <CollectionItemsEditor value={Array.isArray(value) ? (value as CollectionItemConfig[]) : []} addLabel="Add item" onChange={(next) => updateField(propsValue, field, next as JsonValue, onChange)} /> : null}
